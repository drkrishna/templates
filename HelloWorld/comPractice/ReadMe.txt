========================================================================
    ACTIVE TEMPLATE LIBRARY : comPractice Project Overview
========================================================================

AppWizard has created this comPractice project for you to use as the starting point for
...
comPractice.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (comPractice.h)
        GUID definitions                                (comPractice_i.c)
        A type library                                  (comPractice.tlb)
        Marshaling code                                 (comPractice_p.c and dlldata.c)

comPractice.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in comPractice.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named comPractice.pch and a precompiled types file named StdAfx.obj.
...
comPracticeps.vcxproj
	...
	dlldata.c, comPractice_i.c and comPractice_p.c which are required
	to build the proxy/stub DLL.

comPracticeps.vcxproj.filters
